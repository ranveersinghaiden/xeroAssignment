 ...
 *
 * Products   : myeroad */
public class DataRetentionPeriodUpdateModal_input_is_validated_server_sideApiTest {
    ...
    @Test
    @DisplayName("DataRetentionPeriodUpdateModal input is validated server-side")
    void test_dataretentionperiodupdatemodal_input_is_validated_server_side() {
        // GIVEN
        // a malformed or out-of-range retention period value is submitted directly to the server API
        ...
        // THEN
        // the server rejects the value with an appropriate validation error response
    }
}
