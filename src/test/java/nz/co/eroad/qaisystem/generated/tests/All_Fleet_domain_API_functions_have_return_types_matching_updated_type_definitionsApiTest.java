 ...
 *
 * Products   : myeroad */
public class All_Fleet_domain_API_functions_have_return_types_matching_updated_type_definitionsApiTest {
    ...
    @Test
    @DisplayName("All Fleet-domain API functions have return types matching updated type definitions")
    void test_all_fleet_domain_api_functions_have_return_types_matching_updated_type_definitions() {
        // GIVEN
        // the Fleet domain api module has been refactored with updated types
        ...
        // THEN
        // each return type matches the corresponding updated interface in the types module
    }
}
