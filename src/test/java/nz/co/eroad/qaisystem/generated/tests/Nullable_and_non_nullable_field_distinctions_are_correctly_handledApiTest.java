 ...
 *
 * Products   : myeroad */
public class Nullable_and_non_nullable_field_distinctions_are_correctly_handledApiTest {
    ...
    @Test
    @DisplayName("Nullable and non-nullable field distinctions are correctly handled")
    void test_nullable_and_non_nullable_field_distinctions_are_correctly_handled() {
        // GIVEN
        // TSFixMe removal has introduced explicit nullable vs non-nullable field distinctions
        ...
        // THEN
        // the components handle null and undefined values without throwing and render appropriate fallbacks
    }
}
