 ...
 *
 * Products   : myeroad */
public class DateTimeLogonCell_renders_a_formatted_date_time_string_for_a_valid_ISO_timestampUiTest {
    ...
    @Test
    @DisplayName("DateTimeLogonCell renders a formatted date-time string for a valid ISO timestamp")
    void test_datetimelogoncell_renders_a_formatted_date_time_string_for_a_valid_iso_timestamp() {
        // GIVEN
        // DateTimeLogonCell receives a valid ISO 8601 timestamp as its value prop
        ...
        // a formatted human-readable date-time string is displayed
    }
}
