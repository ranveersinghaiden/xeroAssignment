 ...
 *
 * Products   : myeroad */
public class Fleet_API_responses_do_not_include_fields_beyond_what_the_caller_requiresApiTest {
    ...
    @Test
    @DisplayName("Fleet API responses do not include fields beyond what the caller requires")
    void test_fleet_api_responses_do_not_include_fields_beyond_what_the_caller_requires() {
        // GIVEN
        // the Fleet API returns a response after type tightening
        ...
        // THEN
        // no extraneous or sensitive fields beyond the caller's typed interface are present
    }
}
