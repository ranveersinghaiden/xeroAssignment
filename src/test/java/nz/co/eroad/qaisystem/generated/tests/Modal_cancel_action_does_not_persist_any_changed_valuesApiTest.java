 ...
 *
 * Products   : myeroad */
public class Modal_cancel_action_does_not_persist_any_changed_valuesApiTest {
    ...
    @Test
    @DisplayName("Modal cancel action does not persist any changed values")
    void test_modal_cancel_action_does_not_persist_any_changed_values() {
        // GIVEN
        // the DataRetentionPeriodUpdateModal is open and the user has modified the retention value
        ...
        // THEN
        // the retention period shown in the parent component remains unchanged
    }
}
