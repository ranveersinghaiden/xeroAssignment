 ...
 *
 * Products   : myeroad */
public class Out_of_range_retention_period_values_are_rejected_or_clampedApiTest {
    ...
    @Test
    @DisplayName("Out-of-range retention period values are rejected or clamped")
    void test_out_of_range_retention_period_values_are_rejected_or_clamped() {
        // GIVEN
        // a retention period value outside the permitted range is submitted
        ...
        // THEN
        // the value is rejected with a validation error or clamped to the allowed boundary
    }
}
