...
/**
 * Auto-generated UI test for PR : PR-92FD5CFA
 * Scenario                      : Full user flow — load page, view logon table, update data retention, confirm modal, verify new period
 * Context repo                  : null
 *
 * Products   : myeroad */
public class Full_user_flow_load_page_view_logon_table_update_data_retention_confirm_modal_verify_new_periodUiTest {
    ...
    @Test
    @DisplayName("Full user flow — load page, view logon table, update data retention, confirm modal, verify new period")
    void test_full_user_flow_load_page_view_logon_table_update_data_retention_confirm_modal_verify_new_period() {
        // GIVEN
        // an authenticated user navigates to the Fleet driver logon page

        // WHEN
        driver.get("http://localhost:3000");
        // the user views the logon table
        // the user opens the data retention period update modal
        // the user enters a valid new retention period and confirms

        // THEN
        assertThat(driver.getTitle()).isNotEmpty();
        // the modal closes successfully
        // the updated retention period is displayed in the parent component
        // no type errors occur at any step of the flow
    }
}
