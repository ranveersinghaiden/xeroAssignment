 ...
 *
 * Products   : myeroad */
public class All_expected_columns_are_present_in_the_column_definition_arrayApiTest {
    ...
    @Test
    @DisplayName("All expected columns are present in the column definition array")
    void test_all_expected_columns_are_present_in_the_column_definition_array() {
        // GIVEN
        // a valid driver logon dataset
        ...
        // THEN
        // the returned array contains the expected column count with correct keys and header labels
    }
}
