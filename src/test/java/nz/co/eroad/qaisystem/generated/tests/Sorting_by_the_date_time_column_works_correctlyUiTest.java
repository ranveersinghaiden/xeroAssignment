 ...
 *
 * Products   : myeroad */
public class Sorting_by_the_date_time_column_works_correctlyUiTest {
    ...
    @Test
    @DisplayName("Sorting by the date-time column works correctly")
    void test_sorting_by_the_date_time_column_works_correctly() {
        // GIVEN
        // the driver logon card table is displaying data

        // WHEN
        driver.get("http://localhost:3000");
        // the user clicks the date-time column header to sort

        // THEN
        assertThat(driver.getTitle()).isNotEmpty();
        // rows are reordered in the correct ascending or descending date-time order
    }
}
