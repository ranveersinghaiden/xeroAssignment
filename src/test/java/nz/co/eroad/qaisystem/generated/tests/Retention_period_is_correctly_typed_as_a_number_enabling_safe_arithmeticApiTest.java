 ...
 *
 * Products   : myeroad */
public class Retention_period_is_correctly_typed_as_a_number_enabling_safe_arithmeticApiTest {
    ...
    @Test
    @DisplayName("Retention period is correctly typed as a number enabling safe arithmetic")
    void test_retention_period_is_correctly_typed_as_a_number_enabling_safe_arithmetic() {
        // GIVEN
        // the DataRetention API returns a retention period
        ...
        // THEN
        // the value is a numeric type and no type coercion errors occur
    }
}
