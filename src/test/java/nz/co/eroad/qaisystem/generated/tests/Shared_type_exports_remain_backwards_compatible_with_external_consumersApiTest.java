 ...
 *
 * Products   : myeroad */
public class Shared_type_exports_remain_backwards_compatible_with_external_consumersApiTest {
    ...
    @Test
    @DisplayName("Shared type exports remain backwards-compatible with external consumers")
    void test_shared_type_exports_remain_backwards_compatible_with_external_consumers() {
        // GIVEN
        // consumers outside the Fleet domain import shared types from the types module
        ...
        // THEN
        // no compilation errors are produced and all existing usages remain valid
    }
}
