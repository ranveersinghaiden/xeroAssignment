 ...
 *
 * Products   : myeroad */
public class DataRetention_API_returns_the_current_retention_period_settingApiTest {
    ...
    @Test
    @DisplayName("DataRetention API returns the current retention period setting")
    void test_dataretention_api_returns_the_current_retention_period_setting() {
        // GIVEN
        // a configured data retention period exists
        ...
        // THEN
        // the correct retention period value is returned with the correct type
    }
}
