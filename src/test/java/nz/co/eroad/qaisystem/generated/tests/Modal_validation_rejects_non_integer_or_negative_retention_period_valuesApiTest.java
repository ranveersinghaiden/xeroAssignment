 ...
 *
 * Products   : myeroad */
public class Modal_validation_rejects_non_integer_or_negative_retention_period_valuesApiTest {
    ...
    @Test
    @DisplayName("Modal validation rejects non-integer or negative retention period values")
    void test_modal_validation_rejects_non_integer_or_negative_retention_period_values() {
        // GIVEN
