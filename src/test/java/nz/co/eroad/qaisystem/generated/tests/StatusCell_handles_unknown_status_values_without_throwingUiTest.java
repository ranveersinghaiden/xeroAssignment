 ...
 *
 * Products   : myeroad */
public class StatusCell_handles_unknown_status_values_without_throwingUiTest {
    ...
    @Test
    @DisplayName("StatusCell handles unknown status values without throwing")
    void test_statuscell_handles_unknown_status_values_without_throwing() {
        // GIVEN
        // StatusCell receives an unrecognised status value not in the known enum
        ...
        // no exception is thrown and a safe fallback is displayed
    }
}
