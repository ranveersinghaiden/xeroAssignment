 ...
 *
 * Products   : myeroad */
public class Offline_notification_settings_are_loaded_correctly_on_component_initApiTest {
    ...
    @Test
    @DisplayName("Offline notification settings are loaded correctly on component init")
    void test_offline_notification_settings_are_loaded_correctly_on_component_init() {
        // GIVEN
        // the OfflineNotifications component is mounted
        ...
        // THEN
        // all notification settings are loaded and displayed with correct initial state
    }
}
