 ...
 *
 * Products   : myeroad */
public class SettingsToggle_renders_correctly_in_enabled_and_disabled_statesUiTest {
    ...
    @Test
    @DisplayName("SettingsToggle renders correctly in enabled and disabled states")
    void test_settingstoggle_renders_correctly_in_enabled_and_disabled_states() {
        // GIVEN
        // SettingsToggle is rendered with enabled set to true
        ...
        // it displays in the active/on visual state
        // when enabled is set to false it displays in the inactive/off visual state
    }
}
