 ...
 *
 * Products   : myeroad */
public class API_error_response_surfaces_a_user_readable_error_messageApiTest {
    ...
    @Test
    @DisplayName("API error response surfaces a user-readable error message")
    void test_api_error_response_surfaces_a_user_readable_error_message() {
        // GIVEN
        // the DataRetentionPeriodUpdateModal is open and the update API returns an error
        ...
        // THEN
        // a user-readable error message is displayed and no raw type or server error is exposed
    }
}
