...
/**
 * Auto-generated API test for PR : PR-742441AC
 * Scenario                       : Successful operation of ReplayList
 * Tags                           : [@api, @pr-PR-742441AC, @auto-generated]
 * Context repo                   : null
 *
 * Products   : myeroad */
public class Successful_operation_of_ReplayListApiTest {
    ...
    @Test
    @DisplayName("Successful operation of ReplayList")
    void test_successful_operation_of_replaylist() {
        // GIVEN
        // the system is running
        // a valid user session exists
        // the myeroad service is available
