 ...
 *
 * Products   : myeroad */
public class All_imports_of_Fleet_domain_types_from_other_modules_compile_without_errorsApiTest {
    ...
    @Test
    @DisplayName("All imports of Fleet domain types from other modules compile without errors")
    void test_all_imports_of_fleet_domain_types_from_other_modules_compile_without_errors() {
        // GIVEN
        // modules outside the Fleet domain import types from the Fleet types module
        ...
        // THEN
        // all imports resolve successfully and no new compilation errors are introduced
    }
}
