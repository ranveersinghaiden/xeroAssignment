 ...
 *
 * Products   : myeroad */
public class Modal_validation_rejects_values_exceeding_the_maximum_allowed_retention_periodApiTest {
    ...
    @Test
    @DisplayName("Modal validation rejects values exceeding the maximum allowed retention period")
    void test_modal_validation_rejects_values_exceeding_the_maximum_allowed_retention_period() {
        // GIVEN
        // the DataRetentionPeriodUpdateModal is open
        ...
        // THEN
        // a validation error is displayed and the API is not called
    }
}
