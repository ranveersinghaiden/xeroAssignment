 ...
 *
 * Products   : myeroad */
public class DateTimeLogonCell_renders_a_fallback_when_value_is_null_or_undefinedUiTest {
    ...
    @Test
    @DisplayName("DateTimeLogonCell renders a fallback when value is null or undefined")
    void test_datetimelogoncell_renders_a_fallback_when_value_is_null_or_undefined() {
        // GIVEN
        // DateTimeLogonCell receives null or undefined as its value prop
        ...
        // an empty state or placeholder is displayed and no error is thrown
    }
}
