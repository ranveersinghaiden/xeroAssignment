 ...
 *
 * Products   : myeroad */
public class Default_retention_period_is_applied_when_no_explicit_value_is_configuredApiTest {
    ...
    @Test
    @DisplayName("Default retention period is applied when no explicit value is configured")
    void test_default_retention_period_is_applied_when_no_explicit_value_is_configured() {
        // GIVEN
        // no explicit data retention period has been configured
        ...
        // THEN
        // the default retention period is returned
    }
}
