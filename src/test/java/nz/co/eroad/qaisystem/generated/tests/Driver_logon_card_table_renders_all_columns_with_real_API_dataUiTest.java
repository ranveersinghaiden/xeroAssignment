 ...
 *
 * Products   : myeroad */
public class Driver_logon_card_table_renders_all_columns_with_real_API_dataUiTest {
    ...
    @Test
    @DisplayName("Driver logon card table renders all columns with real API data")
    void test_driver_logon_card_table_renders_all_columns_with_real_api_data() {
        // GIVEN
        // the driver logon page is loaded with data returned from the real API

        // WHEN
        driver.get("http://localhost:3000");
        // the logon card table is displayed

        // THEN
        assertThat(driver.getTitle()).isNotEmpty();
        // all expected columns are rendered with correct data in every row
    }
}
