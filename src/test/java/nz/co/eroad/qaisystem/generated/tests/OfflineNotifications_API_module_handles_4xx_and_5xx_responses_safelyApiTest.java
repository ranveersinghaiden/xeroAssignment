 ...
 *
 * Products   : myeroad */
public class OfflineNotifications_API_module_handles_4xx_and_5xx_responses_safelyApiTest {
    ...
    @Test
    @DisplayName("OfflineNotifications API module handles 4xx and 5xx responses safely")
    void test_offlinenotifications_api_module_handles_4xx_and_5xx_responses_safely() {
        // GIVEN
        // the OfflineNotifications API returns a 4xx or 5xx error
        ...
        // THEN
        // no raw error object is exposed to the UI layer and a safe error state is shown
    }
}
