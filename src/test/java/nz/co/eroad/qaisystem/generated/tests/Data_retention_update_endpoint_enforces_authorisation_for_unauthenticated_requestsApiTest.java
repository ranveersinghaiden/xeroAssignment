 ...
 * Tags                           : [@api, @security, @smoke, @regression]
 * Context repo                   : null
 *
 * Products   : myeroad */
public class Data_retention_update_endpoint_enforces_authorisation_for_unauthenticated_requestsApiTest {
    ...
    @Test
    @DisplayName("Data retention update endpoint enforces authorisation for unauthenticated requests")
    void test_data_retention_update_endpoint_enforces_authorisation_for_unauthenticated_requests() {
        // GIVEN
        // no valid authentication credentials are provided
        ...
        // THEN
        // the server responds with HTTP 401 or 403 and the update is not applied
    }
}
