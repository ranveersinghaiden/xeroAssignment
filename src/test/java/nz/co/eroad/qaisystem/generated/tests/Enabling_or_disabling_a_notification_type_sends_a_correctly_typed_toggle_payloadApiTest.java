 ...
 *
 * Products   : myeroad */
public class Enabling_or_disabling_a_notification_type_sends_a_correctly_typed_toggle_payloadApiTest {
    ...
    @Test
    @DisplayName("Enabling or disabling a notification type sends a correctly typed toggle payload")
    void test_enabling_or_disabling_a_notification_type_sends_a_correctly_typed_toggle_payload() {
        // GIVEN
        // the OfflineNotifications component is mounted with existing settings
        ...
        // THEN
        // the API receives a correctly typed payload reflecting the new enabled or disabled state
    }
}
