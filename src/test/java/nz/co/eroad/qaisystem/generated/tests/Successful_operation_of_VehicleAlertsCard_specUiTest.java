...
/**
 * Auto-generated UI test for PR : PR-748E1C7F
 * Scenario                      : Successful operation of VehicleAlertsCard.spec
 * Context repo                  : built-in template
 *
 * Products   : myeroad */
public class Successful_operation_of_VehicleAlertsCard_specUiTest {
    ...
    @Test
    @DisplayName("Successful operation of VehicleAlertsCard.spec")
    void test_successful_operation_of_vehiclealertscard_spec() {
        // GIVEN
