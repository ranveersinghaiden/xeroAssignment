 ...
 *
 * Products   : myeroad */
public class SettingsToggle_ignores_clicks_when_the_disabled_prop_is_trueUiTest {
    ...
    @Test
    @DisplayName("SettingsToggle ignores clicks when the disabled prop is true")
    void test_settingstoggle_ignores_clicks_when_the_disabled_prop_is_true() {
        // GIVEN
        // SettingsToggle is rendered with the disabled prop set to true
        ...
        // the onChange callback is not invoked and the toggle state does not change
    }
}
