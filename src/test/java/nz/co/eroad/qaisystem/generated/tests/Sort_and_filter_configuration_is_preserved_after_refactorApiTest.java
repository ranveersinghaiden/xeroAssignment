 ...
 *
 * Products   : myeroad */
public class Sort_and_filter_configuration_is_preserved_after_refactorApiTest {
    ...
    @Test
    @DisplayName("Sort and filter configuration is preserved after refactor")
    void test_sort_and_filter_configuration_is_preserved_after_refactor() {
        // GIVEN
        // column definitions were previously configured with sort and filter options
        ...
        // THEN
        // sort and filter configuration on each column is identical to the pre-refactor baseline
    }
}
