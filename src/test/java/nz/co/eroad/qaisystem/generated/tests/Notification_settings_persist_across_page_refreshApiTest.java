 ...
 *
 * Products   : myeroad */
public class Notification_settings_persist_across_page_refreshApiTest {
    ...
    @Test
    @DisplayName("Notification settings persist across page refresh")
    void test_notification_settings_persist_across_page_refresh() {
        // GIVEN
        // the user has updated an offline notification setting
        ...
        // THEN
        // the updated setting is retrieved from the API and displayed correctly
    }
}
