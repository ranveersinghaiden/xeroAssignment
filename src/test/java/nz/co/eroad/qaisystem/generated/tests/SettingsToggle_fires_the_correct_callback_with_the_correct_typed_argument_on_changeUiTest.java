 ...
 *
 * Products   : myeroad */
public class SettingsToggle_fires_the_correct_callback_with_the_correct_typed_argument_on_changeUiTest {
    ...
    @Test
    @DisplayName("SettingsToggle fires the correct callback with the correct typed argument on change")
    void test_settingstoggle_fires_the_correct_callback_with_the_correct_typed_argument_on_change() {
        // GIVEN
        // SettingsToggle is rendered with an onChange callback
        ...
        // the onChange callback is invoked with the correctly typed boolean argument reflecting the new state
    }
}
