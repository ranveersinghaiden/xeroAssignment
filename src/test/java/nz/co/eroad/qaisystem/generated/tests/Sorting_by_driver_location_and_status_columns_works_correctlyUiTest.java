 ...
 *
 * Products   : myeroad */
public class Sorting_by_driver_location_and_status_columns_works_correctlyUiTest {
    ...
    @Test
    @DisplayName("Sorting by driver, location, and status columns works correctly")
    void test_sorting_by_driver_location_and_status_columns_works_correctly() {
        // GIVEN
        // the driver logon card table is displaying data

        // WHEN
        driver.get("http://localhost:3000");
        // the user clicks the driver, location, or status column header to sort

        // THEN
        assertThat(driver.getTitle()).isNotEmpty();
        // rows are reordered according to the selected column without error
    }
}
