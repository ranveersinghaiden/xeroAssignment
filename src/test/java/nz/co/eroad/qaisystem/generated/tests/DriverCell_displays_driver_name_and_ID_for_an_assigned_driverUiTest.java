 ...
 *
 * Products   : myeroad */
public class DriverCell_displays_driver_name_and_ID_for_an_assigned_driverUiTest {
    ...
    @Test
    @DisplayName("DriverCell displays driver name and ID for an assigned driver")
    void test_drivercell_displays_driver_name_and_id_for_an_assigned_driver() {
        // GIVEN
        // DriverCell receives a fully populated driver object with name and ID
        ...
        // the driver name and driver ID are both visible in the cell
    }
}
