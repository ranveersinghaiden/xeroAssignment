 ...
 *
 * Products   : myeroad */
public class API_request_payloads_are_serialised_correctly_with_no_unexpected_any_typed_fieldsApiTest {
    ...
    @Test
    @DisplayName("API request payloads are serialised correctly with no unexpected any-typed fields")
    void test_api_request_payloads_are_serialised_correctly_with_no_unexpected_any_typed_fields() {
        // GIVEN
        // a Fleet domain API function is called with a typed request object
        ...
        // THEN
        // all fields are serialised to their expected JSON types with no unexpected any coercion
    }
}
