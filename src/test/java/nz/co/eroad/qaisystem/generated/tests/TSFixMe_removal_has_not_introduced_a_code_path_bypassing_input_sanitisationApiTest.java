 ...
 *
 * Products   : myeroad */
public class TSFixMe_removal_has_not_introduced_a_code_path_bypassing_input_sanitisationApiTest {
    ...
    @Test
    @DisplayName("TSFixMe removal has not introduced a code path bypassing input sanitisation")
    void test_tsfixme_removal_has_not_introduced_a_code_path_bypassing_input_sanitisation() {
        // GIVEN
        // all new code paths introduced by TSFixMe replacement are identified
        ...
        // THEN
        // input sanitisation is applied on every path and no bypass is possible
    }
}
