 ...
 *
 * Products   : myeroad */
public class Column_definitions_return_correctly_for_an_empty_driver_logon_arrayApiTest {
    ...
    @Test
    @DisplayName("Column definitions return correctly for an empty driver logon array")
    void test_column_definitions_return_correctly_for_an_empty_driver_logon_array() {
        // GIVEN
        // driver logon data is an empty array
        ...
        // THEN
        // the definition array is returned without error and all columns are present
    }
}
