 ...
 * 2. Check `common/` first — if the class already exists there, import java.util.concurrent.TimeUnit;
 ...
 *    - `@Test
    @Timeout(value = 30, unit = TimeUnit.SECONDS)
    @Timeout(value = 30, unit = TimeUnit.SECONDS)` annotation
 ...
 *
 * Products   : myeroad */
public class API_functions_handle_network_timeout_and_abort_correctlyApiTest {
    ...
    @Timeout(value = 30, unit = TimeUnit.SECONDS)
    @Timeout(value = 30, unit = TimeUnit.SECONDS)
    @DisplayName("API functions handle network timeout and abort correctly")
    void test_api_functions_handle_network_timeout_and_abort_correctly() {
        // GIVEN
        // a Fleet domain API call is in flight
        ...
        // THEN
        // the API function rejects with a typed error and does not hang or throw an unhandled exception
    }
}
