 ...
 *
 * Products   : myeroad */
public class API_response_shapes_conform_to_newly_typed_interfacesApiTest {
    ...
    @Test
    @DisplayName("API response shapes conform to newly typed interfaces")
    void test_api_response_shapes_conform_to_newly_typed_interfaces() {
        // GIVEN
        // the api module returns responses shaped to updated TypeScript interfaces
        ...
        // THEN
        // no silent any-to-typed coercion gaps exist and all fields are correctly typed
    }
}
