 ...
 *
 * Products   : myeroad */
public class DateTimeLogonCell_handles_timezone_correctlyUiTest {
    ...
    @Test
    @DisplayName("DateTimeLogonCell handles timezone correctly")
    void test_datetimelogoncell_handles_timezone_correctly() {
        // GIVEN
        // DateTimeLogonCell receives a UTC ISO timestamp

        // WHEN
        driver.get("http://localhost:3000");
        // the component renders with a configured local timezone

        // THEN
        assertThat(driver.getTitle()).isNotEmpty();
        // the displayed time reflects the correct local offset and not raw UTC
    }
}
