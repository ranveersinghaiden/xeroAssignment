 ...
 *
 * Products   : myeroad */
public class Authentication_and_authorisation_headers_are_present_on_all_Fleet_API_callsApiTest {
    ...
    @Test
    @DisplayName("Authentication and authorisation headers are present on all Fleet API calls")
    void test_authentication_and_authorisation_headers_are_present_on_all_fleet_api_calls() {
        // GIVEN
        ...
        // THEN
        // the request includes the required authentication and authorisation headers
    }
}
