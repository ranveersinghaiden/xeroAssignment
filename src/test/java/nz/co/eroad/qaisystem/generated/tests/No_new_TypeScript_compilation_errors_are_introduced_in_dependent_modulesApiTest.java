 ...
 *
 * Products   : myeroad */
public class No_new_TypeScript_compilation_errors_are_introduced_in_dependent_modulesApiTest {
    ...
    @Test
    @DisplayName("No new TypeScript compilation errors are introduced in dependent modules")
    void test_no_new_typescript_compilation_errors_are_introduced_in_dependent_modules() {
        // GIVEN
        // all modules that depend on Fleet domain exports are compiled together
        ...
        // THEN
        // the compilation completes with zero new errors in any dependent module
    }
}
