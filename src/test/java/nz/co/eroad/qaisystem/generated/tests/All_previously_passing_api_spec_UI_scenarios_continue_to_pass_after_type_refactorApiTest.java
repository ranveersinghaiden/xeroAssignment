 ...
 *
 * Products   : myeroad */
public class All_previously_passing_api_spec_UI_scenarios_continue_to_pass_after_type_refactorApiTest {
    ...
    @Test
    @DisplayName("All previously passing api.spec UI scenarios continue to pass after type refactor")
    void test_all_previously_passing_api_spec_ui_scenarios_continue_to_pass_after_type_refactor() {
        // GIVEN
        // the api.spec test suite existed before the TSFixMe removal
        ...
        // THEN
        // all previously passing scenarios still pass with no regressions
    }
}
