 ...
 *
 * Products   : myeroad */
public class Strict_typed_props_satisfy_new_signatures_at_all_call_sitesApiTest {
    ...
    @Test
    @DisplayName("Strict-typed props satisfy new signatures at all call sites")
    void test_strict_typed_props_satisfy_new_signatures_at_all_call_sites() {
        // GIVEN
        // the Fleet domain components have had TSFixMe removed
        ...
        // THEN
        // no `any` coercion exists at any call site and all props conform to their strict type signatures
    }
}
