 ...
 *
 * Products   : myeroad */
public class Modal_submission_sends_a_correctly_typed_payload_to_the_update_APIApiTest {
    ...
    @Test
    @DisplayName("Modal submission sends a correctly typed payload to the update API")
    void test_modal_submission_sends_a_correctly_typed_payload_to_the_update_api() {
        // GIVEN
        // the DataRetentionPeriodUpdateModal is open with a valid new retention value
        ...
        // THEN
        // the update API receives a payload with the retention period as a correctly typed integer
    }
}
