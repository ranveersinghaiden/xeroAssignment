 ...
 *
 * Products   : myeroad */
public class Error_responses_are_typed_and_do_not_leak_server_side_details_to_the_callerApiTest {
    ...
    @Test
    @DisplayName("Error responses are typed and do not leak server-side details to the caller")
    void test_error_responses_are_typed_and_do_not_leak_server_side_details_to_the_caller() {
        // GIVEN
        // a Fleet API call returns an error response containing server-side detail
        ...
        // THEN
        // only a typed, sanitised error object is returned to the caller and raw server details are not exposed
    }
}
