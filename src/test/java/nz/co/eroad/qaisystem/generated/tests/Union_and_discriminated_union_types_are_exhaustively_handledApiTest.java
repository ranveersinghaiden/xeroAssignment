 ...
 *
 * Products   : myeroad */
public class Union_and_discriminated_union_types_are_exhaustively_handledApiTest {
    ...
    @Test
    @DisplayName("Union and discriminated union types are exhaustively handled")
    void test_union_and_discriminated_union_types_are_exhaustively_handled() {
        // GIVEN
        // TSFixMe has been replaced with union or discriminated union types
        ...
        // THEN
        // every variant is handled and no unmatched branch causes a runtime error
    }
}
