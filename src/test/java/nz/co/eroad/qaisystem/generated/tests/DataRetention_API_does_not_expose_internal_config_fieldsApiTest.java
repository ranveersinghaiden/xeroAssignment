 ...
 *
 * Products   : myeroad */
public class DataRetention_API_does_not_expose_internal_config_fieldsApiTest {
    ...
    @Test
    @DisplayName("DataRetention API does not expose internal config fields")
    void test_dataretention_api_does_not_expose_internal_config_fields() {
        // GIVEN
        // the DataRetention API response is inspected
        ...
        // THEN
        // no previously hidden internal configuration fields are present in the response
    }
}
