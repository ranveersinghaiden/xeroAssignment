 ...
 * Scenario                      : StatusCell renders the correct badge for all known status values
 * Context repo                  : null
 *
 * Products   : myeroad */
public class StatusCell_renders_the_correct_badge_for_all_known_status_valuesUiTest {
    ...
    @Test
    @DisplayName("StatusCell renders the correct badge for all known status values")
    void test_statuscell_renders_the_correct_badge_for_all_known_status_values() {
        // GIVEN
        // StatusCell receives the status value "<status>"
        ...
        // the correct badge or label "<expected_label>" is displayed
    }
}
