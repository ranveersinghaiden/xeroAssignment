 ...
 *
 * Products   : myeroad */
public class Cell_renderers_are_correctly_wired_to_their_respective_columnsApiTest {
    ...
    @Test
    @DisplayName("Cell renderers are correctly wired to their respective columns")
    void test_cell_renderers_are_correctly_wired_to_their_respective_columns() {
        // GIVEN
        // the column definitions are generated
        ...
        // THEN
        // DateTimeLogonCell is wired to the date-time column, DriverCell to the driver column, LocationCell to the location column, and StatusCell to the status column
    }
}
